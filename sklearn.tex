...
\end{minted}
We quickly remark that the above method chaining implies that the methods have\footnote{actually \mintinline{python}!fit! takes an optional \mintinline{python}!y! input for supervised learning.} the signatures
\begin{minted}{python}
